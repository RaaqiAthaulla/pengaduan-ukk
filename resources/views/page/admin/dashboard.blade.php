...
@section('content')
    <div class="container-fluid py-4">
        <h4 class="font-weight-bolder text-white mb-2">Halo, Admin! Selamat datang kembali.</h6>
            <div class="row">
                <div class="col-xl-4 col-sm-5 mb-xl-0 mb-4">
                    <div class="card">
                        <div class="card-body p-3">
                            <div class="row">
                                <div class="col-8">
                                    <div class="numbers">
                                        <p class="text-sm mb-0 text-uppercase font-weight-bold">Pengaduan Masyarakat
                                        </p>
                    ...
                    <div class="card">
                        <div class="card-body p-4">
                            <div class="row">
                                <div class="col-8">
                                    <div class="numbers">
                                        <p class="text-sm mb-0 text-uppercase font-weight-bold">Belum Di Proses</p>
                                        <h5 class="font-weight-bolder">
                                            12
                                        </h5>
                                    </div>
                    ...
                    <div class="card">
                        <div class="card-body p-4   ">
                            <div class="row">
                                <div class="col-8">
                                    <div class="numbers">
                                        <p class="text-sm mb-0 text-uppercase font-weight-bold"> Sudah Di Proses</p>
                                        <h5 class="font-weight-bolder">
                                            20
                                        </h5>
                                    </div>
