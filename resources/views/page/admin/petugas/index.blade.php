                                    ...
                                    <table class="table align-items-center mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <p class="text-xs font-weight-bold mb-0">2423423</p>
                                                ...
                                                <td class="align-middle text-center">
                                                    <span class="badge badge-sm bg-gradient-success">Sudah di proses</span>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle text-center text-sm">
                                                    <span class="text-secondary text-xs font-weight-bold">20/04/18</span>
                                                </td>
                                                <td class="align-middle text-center">
                                                    <span class="badge badge-sm bg-gradient-success">Sudah di proses</span>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle text-center text-sm">
                                                    <span class="text-secondary text-xs font-weight-bold">10/04/18</span>
                                                </td>
                                                <td class="align-middle text-center">
                                                    <span class="badge badge-sm bg-gradient-success">Sudah di proses</span>
                                                </td>
