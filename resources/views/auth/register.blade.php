                            ...
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="mb-3">
                                    <input id="nik" type="text"
                                        ...
                                        value="{{ old('nik') }}" required autocomplete="name" autofocus
                                ...
                                <div class="mb-3">
                                    <input id="nama" type="text"
                                        ...
                                        value="{{ old('nama') }}" required autocomplete="name" placeholder="Name"
                                        aria-label="Name">
                                    @error('nama')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                ...
                                <div class="mb-3">
                                    <input id="tlp" type="text"
                                        ...
                                        value="{{ old('tlp') }}" required autocomplete="tlp" placeholder="No HP"
                                        aria-label="tlp">
                                    @error('tlp')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
